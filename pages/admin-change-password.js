...
import AdminPasswordChangeBlock from "../components/Blocks/Admin/AdminPasswordChangeBlock";
    ...
    return(
        <MainContentWrapper theme = "ChangePwd">
            ...
            <ContentBody>
                ...
                <NavbarComponent manageAdminUserPrivilege ={manageAdminUserPrivilege} pendingCSPUserListPrivilege ={pendingCSPUserListPrivilege}/>

                <Container>
                    <AdminPasswordChangeBlock onPageReload = {pageReload}/>
                </Container>
            </ContentBody>
        </MainContentWrapper>
    )
