...
const CspPendingUsersApi = (req, res)=>{
    ...
    if(req.method === "POST"){
        ...
        .then(resp =>{
            ...
            if(responseCode === 200){
                ...
                const pendingListDetails = resp.hasOwnProperty('data')?  resp.data : '';
                const userDetails = pendingListDetails.hasOwnProperty('userDetails') ? pendingListDetails.userDetails : '';
...
export default CspPendingUsersApi