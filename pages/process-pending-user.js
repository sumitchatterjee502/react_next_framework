...
import ProcessPendingBlock from "../components/Blocks/Pending/ProcessPendingBlock";


const ProcessPendingUser = ()=>{
    ...
    return (
        <MainContentWrapper>
            ...
            <ContentBody>
                ...
                <NavbarComponent active = "processPending" manageAdminUserPrivilege ={manageAdminUserPrivilege} pendingCSPUserListPrivilege ={pendingCSPUserListPrivilege} onGetDate ={getDateFromCalender} passDate={dateFull}/>

                <ProcessPendingBlock sendChoosingDate ={choosingDate} passDefaultDate={dateFull} onPageReload ={pageReload}/>
            </ContentBody>
        </MainContentWrapper>
    )
}

export default ProcessPendingUser